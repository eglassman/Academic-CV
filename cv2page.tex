...
Human-Computer Interaction • Human-AI Interaction and Interface Design
...
\years{2016-2018}\textbf{EECS Postdoctoral Scholar} \hfill Berkeley Institute of Design, EECS Department, UC Berkeley\\[0.05cm]
...
\years{2012-2016}\textbf{PhD student} \hfill User Interface Design Group, EECS Department, CSAIL, MIT\\[0.05cm]
...
\years{2015}\textbf{User experience research intern} \hfill Search, Google\\
Advised by Dan Russell, Senior Research Scientist\\
\years{2014}\textbf{Design research intern} \hfill Microsoft Research\\
Advised by M.R. Morris, Principal Researcher, and A. Monroy-Hernández, Researcher\\
\years{2008-2011}\textbf{Graduate student}\hfill Robot Locomotion Group, EECS Department, CSAIL, MIT\\[0.05cm]
...
\years{2010-2011}\textbf{Visiting researcher} \hfill Biomimetics \& Dexterous Manipulation Lab, Stanford University\\
\years{2006-2008}\textbf{Undergraduate researcher} \hfill Robot Locomotion Group, CSAIL, MIT\\
\years{2004-2006}\textbf{Undergraduate researcher} \hfill Networks \& Mobile Systems, CSAIL, MIT\\
\years{2003-2004}\textbf{Volunteer research assistant} \hfill EEG Lab, Psychology Department, Princeton University
...
\noindent
Top-tier ACM and AAAI conferences in human-computer interaction and adjacent fields (e.g., CHI, CSCW, UIST, IUI, and HRI) are highly selective venues for archival papers only, comparable to many IEEE journals in their selectivity, visibility, and impact.\\[0.1cm]
\textbf{CHI is the flagship HCI conference}, with an acceptance rate is typically 20-25\%. Top \textit{n}\% awards are given to the top \textit{n}\% of \textit{submitted} papers.\\[0.1cm]
...
%Authors are typically ordered such that leading students are listed from largest to smallest contribution from the left. Supervising faculty and postdocs are typically ordered from the right. The last author is the primary sponsor and supervisor.\\[0.2cm] %, and project advisor.
...
% Flagship HCI conference, acceptance rate is typically 20-25\%\\%[0.05cm]
% Flagship HCI conference, 26.4\% acceptance rate (33.9\% for Late Breaking Work or LBW).\\

\years{UIST'25}Z Gu, J Zhou, NE Lei, JK Kummerfeld, M Jasim, N Mahyar, \textbf{EL Glassman}\\
\href{https://glassmanlab.seas.harvard.edu/papers/abstractexplorer.pdf}{AbstractExplorer: Leveraging Structure-Mapping Theory to Enhance Comparative Close Reading at Scale}\\[0.2cm]
\years{CHI'25}\hl{\textbf{Best Paper Award (top 1\%)}}\\
...
[0.2cm]
\years{CHI'25}\hl{\textbf{Best Paper Award (top 1\%)}}\\
KI Gero, M Desai, C Schnitzler, N Eom, J Cushman, \textbf{EL Glassman}\\
\href{https://arxiv.org/abs/2409.14281}{Creative Writers’ Attitudes on Writing as Training Data for Large Language Models}\\
[0.2cm]
\years{ACL'25}SA Gebreegziabher, K Ai, Z Zhang, \textbf{EL Glassman}, TJ Li\\
\href{https://glassmanlab.seas.harvard.edu/papers/leveragingVT_acl.pdf}{Leveraging Variation Theory in Counterfactual Data Augmentation for Optimized Active Learning}\\
[0.2cm]
...
%\years{\textbf{C35}} 
\years{CHI'24}Z Gu, I Arawjo, K Li, JK Kummerfeld, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/gptsm.pdf}{An AI-Resilient Text Rendering Technique for Reading and Skimming Documents}\\
...
[0.2cm]
%\years{\textbf{C34}}
\years{CHI'24}\hl{\textbf{Best of CHI Honorable Mention (top 5\%)}}\\ KI Gero, C Swoopes, Z Gu, JK Kummerfeld, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/mesotext.pdf}{Supporting Sensemaking of Large Language Model Outputs at Scale}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
%\years{\textbf{C33}}
\years{CHI'24}\hl{\textbf{Best of CHI Honorable Mention (top 5\%)}}\\ I Arawjo, C Swoopes, P Vaithilingam, M Wattenberg, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/chainforge.pdf}{ChainForge: A Visual Toolkit for Prompt Engineering and LLM Hypothesis Testing}\\
\emph{Open sourced and hosted at \href{https://chainforge.ai/}{https://chainforge.ai/}}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{CHI'24}\hl{\textbf{Best Paper Award (top 1\%)}}\\ P Vaithilingam, \textbf{EL Glassman}, JP Inala, C Wang\\ \href{https://glassmanlab.seas.harvard.edu/papers/dynavis.pdf}{DynaVis: Dynamically Synthesized UI Widgets for Visualization Editing}\\
[0.2cm]
...
% Typically 20-25\% acceptance rate.\\
\years{HRI'22}S Booth, S Sharma, S Chung, J Shah, \textbf{EL Glassman}\\
...
% [0.2cm]
\years{CHI'22 LBW}P Vaithilingam, T Zhang, \textbf{EL Glassman}\\
...
\textbf{Cited 1221 times since May 2022, making it one of the most cited HCI papers in the last 5 years}\\
[0.2cm]
%\emph{Extended Abstracts of the 2022 CHI Conference on Human Factors in Computing Systems}\\[0.2cm]
\years{IUI'20}\hl{\textbf{Best Paper Award}}\\
Z Bucinca*, P Lin*, K Gajos, \textbf{EL Glassman}\\
\href{http://glassmanlab.seas.harvard.edu/papers/bucinca_iui20_proxy.pdf}{Proxy Tasks and Subjective Measures Can Be Misleading in Evaluating XAI Systems}\\
%\emph{ACM Intelligent User Interfaces}\\
\textbf{Cited 514 times since March 2020}
\newpage
...
\years{2024-2025}\textit{Paper Co-Chair} (one of four)\hfill ACM UIST\\
...
\years{2024}Ad hoc CAREER grant review\hfill NSF\\
