...
\noindent
Top-tier ACM and AAAI conferences in human-computer interaction and adjacent fields, e.g., CHI, CSCW, UIST, IUI, HRI, and ICWSM, are highly selective venues for archival papers only, comparable to many IEEE journals in their selectivity, visibility, and impact. ACM \textbf{CHI}, the Conference on Human Factors in Computing Systems, is the \emph{flagship HCI conference}, with an acceptance rate is typically 20-25\%. Top \textit{n}\% awards are given to the top \textit{n}\% of submitted papers.\\[0.1cm]
...
\textbf{Cited 922 times since May 2022, making it one of the most cited HCI papers in the last 5 years}
