...
Human-computer interaction • Data science • Machine teaching • Programming education at scale 
...
\\
\years{2016}\textbf{MIT \textsc{Ph.D.}}, Electrical Engineering \& Computer Science\\ %\hfill CSAIL User Interface Design Group\\ %\hfill CS \& AI Lab, MIT\\
\emph{Clustering and Visualizing Solution Variation in Massive Programming Classes}\\
Advisor: Robert C. Miller, Professor of Computer Science\\\\
\years{2010}\textbf{Stanford University}, Visiting researcher \hfill Biomimetics \& Dexterous Manipulation Lab\\
Host: Mark R. Cutkosky, Professor of Mechanical Engineering\\\\
\years{2010}\textbf{MIT \textsc{M.Eng.}}, Electrical Engineering \& Computer Science\\ %\hfill CSAIL Robot Locomotion Group\\
\emph{A quadratic regulator-based heuristic for rapidly exploring state space}\\
Advisor: Russ Tedrake, Professor of EECS\\\\
%\years{2008-2010}\textbf{MIT}, EECS Graduate researcher \hfill CSAIL Robot Locomotion Group\\
\years{2008}\textbf{MIT \textsc{B.S.}}, Electrical Science \& Engineering\\\\ %\hfill Cambridge, MA\\\\
\years{2004-2008}\textbf{MIT} CSAIL Undergraduate researcher\\ %\hfill CSAIL\\
...
\years{2015}\textbf{Google}, User Experience Research Intern \hfill Search\\
Mentor: Dan Russell, Senior Research Scientist\\\\
\years{2014}\textbf{Microsoft Research}, Design research intern \hfill neXus Research Team\\
Mentors: Meredith Ringel Morris, Principal Researcher, and Andrés Monroy-Hernández, Researcher\\
...
% \subsection*{Theses}
% \noindent
% \years{2016}``Clustering and Visualizing Solution Variation in Massive Programming Classes''\\ %\textbf{E Glassman}\\ 
% \textsc{Ph.D.} Thesis, MIT Electrical Engineering \& Computer Science. \\\\
% \years{2010}``A quadratic regulator-based heuristic for rapidly exploring state space''\\
% %\textbf{E Glassman} \\
...
\small{Top-tier ACM conferences in human-computer interaction, i.e., CHI, CSCW, and UIST, are highly selective venues intended for archival papers only. These conferences are comparable or exceed many IEEE journals in their selectivity, visibility, and impact. For more details, see ``Selectivity and Impact'' by Jilin Chen and Joseph Konstan.}\\\\
\noindent
%\emph{Learning at scale}\\
...
\textbf{Best of CHI Honorable Mention (top 5\%).}\\\\
\years{2015 CHI}
...
\emph{Design Recommendations for Intelligent Tutoring Systems: Domain Modeling} Vol. 4, US Army Research Laboratory, July 2016.
...
\noindent
\years{2017}Moore-Sloan Data Science Summit hosted by Moore-Sloan Foundation \hfill New Orleans\\
...
\textbf{Scott Klemmer}\\
Professor of Cognitive Science and \\Computer Science \& Engineering\\University of California, San Diego\\
