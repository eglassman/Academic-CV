...
\small{Top-tier ACM conferences in human-computer interaction, i.e., CHI, CSCW, \& UIST, are highly selective venues for archival papers only, comparable to many IEEE journals in their selectivity, visibility, and impact.} \\
\small{\emph{* indicates equal contribution.}}
...
\emph{ACM SIGKDD Conference on Knowledge Discovery and Data Mining workshop: Machine Learning for Education}, 2017.\\\\
\years{2017 CHI}
...
\noindent
\years{2018}SPLASH Live Programming Workshop (LIVE), for new ideas on improving the usability of programming\\
...
\noindent
\years{2019}ACM UIST Student Innovation Contest Chair\\
