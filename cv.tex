...
{\large Assistant Professor of Computer Science at Harvard University\\ 
...
33 Oxford St. Rm 241\\
Cambridge, MA 02138 USA\\%[.2cm] \texttt{94720} 
\texttt{+1 215-694-9631}\\
 %\\%[.2cm]
\href{mailto:glassman@seas.harvard.edu}{glassman@seas.harvard.edu} \\
\href{http://glassmanlab.seas.harvard.edu/}{glassmanlab.seas.harvard.edu}
...
\years{2016-2018}EECS Postdoctoral Scholar, Berkeley Institute of Design \hfill UC Berkeley\\
\emph{Supervised by} Bj{\"o}rn Hartmann, Associate Professor of EECS\\
\emph{Funded by} NSF Expeditions in Computer Augmented Program Engineering\\ and the Berkeley Institute of Data Science Postdoctoral Fellowship\\
\years{2012-2016}PhD student, User Interface Design Group \hfill CSAIL, MIT\\
\emph{Advised by} Robert Miller, Distinguished Professor of Computer Science\\
\years{2010-2011}Visiting researcher, Biomimetics \& Dexterous Manipulation Lab\hfill Stanford University\\
\years{2008-2011}Graduate researcher, Robot Locomotion Group\hfill CSAIL, MIT\\
\years{2004-2008}Undergraduate researcher\hfill CSAIL, MIT\\
\years{2003-2004}High school student researcher (invited), EEG Lab\hfill Princeton University
...
\emph{Advised by} Meredith Ringel Morris, Principal Researcher,\\ and Andrés Monroy-Hernández, Researcher
...
\years{2018}Named a Radcliffe Assistant Professor at the Radcliffe Institute for Advanced Study\\
...
\subsection*{Theses}
\noindent
\years{2016 MIT}``Clustering and Visualizing Solution Variation in Massive Programming Classes''\\ %\textbf{EL Glassman}\\ 
...
\emph{IEEE Symposium on Visual Languages and Human-Centric Computing} (VL/HCC), 2019.\\
\emph{31-33\% acceptance rate}\\\\
...
\emph{25.8\% acceptance rate}\\\\
\years{2018 CHI} A Head, \textbf{EL Glassman}, B Hartmann, and M Hearst\\
...
\emph{ACM Conference on Knowledge Discovery and Data Mining}, 2017.\\\\
\years{2017 CHI}
R Suzuki, G Soares, {\bf EL Glassman}, A Head, L D'Antoni, and B Hartmann\\
``Exploring the Design Space of Automatically Synthesized Hints for Introductory Programming Assignments'' \\ \emph{ACM Conference on Human Factors in Computing Systems} (CHI), 2017.\\\\
\years{2017 L@S} 
...
\noindent
\textit{Journals}\\
\years{2018}Empirical Software Engineering (EMSE) (journal)\\
...
\noindent
\years{2017}Approaches and Applications of Inductive Programming \hfill Wadern, Germany
