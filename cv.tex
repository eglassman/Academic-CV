...
\noindent
\years{2016}Consultant \hfill Search, Google\\
...
\years{2011-2014}NSF Graduate Research Fellow\\
\years{2008-2011}National Defense Science and Engineering Graduate Fellow\\
\years{2004} IEEE President's Scholarship (\$10,000)\\
\years{2003} Intel Foundation Young Scientist Award (\$50,000)\\%, top 3 at Intel International Science \& Engineering Fair\\
...
\years{2003} Best of Category: Computer Science (\$5,000), Intel International Science and Engineering Fair\\

\section*{Teaching}
\years{2016}Co-lecturer, User Interface Design \& Implementation, (175 students) \hfill MIT EECS\\
\years{2013}Co-lecturer, introductory python programming \hfill MIT MEET, Jerusalem\\
\years{2013}Video creator, radio receiver technology\hfill MIT Teaching \& Learning Lab\\
...
\years{2015}B Kim, \textbf{EL Glassman}, B Johnson, J Shah. ``iBCM: Interactive Bayesian Case Model Empowering Humans via Intuitive Interaction.'' MIT CSAIL TR-2015-010.

\subsection*{Book Chapters}
\noindent
%\emph{Learning at scale}\\
\years{2016}JJ Williams, J Kim, \textbf{EL Glassman}, A Rafferty, W Lasecki. ``Making Static Lessons Adaptive through Crowdsourcing \& Machine Learning.'' \emph{Volume 4 of Design Recommendations for Intelligent Tutoring Systems}. US Army Research Laboratory.

\subsection*{Theses}
\noindent
%\emph{Learning at scale}\\
\years{2016}\textbf{EL Glassman}. ``Clustering and Visualizing Solution Variation in Massive Programming Classes.'' MIT EECS Ph.D. Thesis.\\[.2cm]
%\emph{Underactuated robotics}\\
...
\years{2015}Human-Computer Interaction, Stanford University\\
...
\years{2016} Presenter. ``Learning Latent Student Design Decisions in Python Programming Classes.'' Workshop on Machine Learning for Digital Education and Assessment Systems, \emph{International Conference on Machine Learning (ICML)}.\\
\years{2015} Presenter. Rising Stars Workshop for aspiring CS faculty, MIT.\\
\years{2015} Presenter. ``Interacting with massive numbers of student solutions.'' Doctoral consortium, \emph{ACM Symposium on User Interface Software \& Technology (UIST)}.\\
\years{2013} Presenter. ``Visualizing and classifying multiple solutions to engineering design problems.'' Doctoral consortium, \emph{ACM International Computing Education Research (ICER)}.

\subsection*{Poster and demo presentations}
\noindent
\years{2016}{\bf EL Glassman}. ``Learning Latent Student Design Decisions in Massive Python Programming Classes.'' \emph{New England Machine Learning Day}.\\
\years{2016}{\bf EL Glassman}, RC Miller. ``Leveraging Learners for Teaching Programming and Hardware Design at Scale.'' \emph{ACM Computer-Supported Cooperative Work and Social Computing (CSCW)}.\\
\years{2015}{\bf EL Glassman}, CJ Terman, RC Miller. ``Learner-Sourcing in an Engineering Class at Scale.'' \emph{ACM Learning at Scale Conference (L$@$S)}.\\
\years{2014}{\bf EL Glassman}. ``Interacting with massive numbers of student solutions.'' \emph{ACM Symposium on User Interface Software \& Technology (UIST)}.\\
\years{2014}{\bf EL Glassman}, R Singh, RC Miller. ``Feature engineering for clustering student solutions.'' \emph{ACM Learning at Scale Conference (L$@$S)}.\\
\years{2009}{\bf EL Glassman}. Women in Machine Learning Workshop, \emph{Neural Information Processing Systems (NIPS)}.
...
\noindent
\years{2013-2015}President, Middle East Education through Technology\\
%\years{2012}Co-organizer, MIT edTech reading group\\
\years{2008-2009}Vice-President, Eta Kappa Nu EECS honor society\\

%\hrule
\subsection*{Research mentoring}
\noindent
\years{2016}Eric Pai, UC Berkeley EECS undergraduate\\
\years{2016}Michelle Tian, UC Berkeley EECS undergraduate\\
\years{2016}Daniel Nguyen, UC Berkeley EECS undergraduate\\
\years{2016}Andrew Head, UC Berkeley EECS Ph.D. student\\
\years{2016}Sindy Tan, Harvard EECS undergraduate\\
\years{2015-2016}Stacey Terman, MIT EECS M.Eng. student\\
%\years{2012}Co-organizer, MIT edTech reading group\\
\years{2015}Aaron Lin, MIT EECS undergraduate\\
...
\years{2015--}ACM CHI, UIST, CSCW reviewer\\
