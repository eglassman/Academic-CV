...
Human-computer interaction • Program synthesis • Programming education at scale 

%%\hrule
\section*{Academic positions}
\noindent
\years{2017-present}Moore/Sloan Data Science Fellow, Berkeley Institute for Data Science \hfill UC Berkeley\\
\years{2016-present}Postdoctoral Scholar, Berkeley Institute of Design, EECS \hfill UC Berkeley\\
...
\years{2003-2004}Volunteer researcher, EEG Lab\hfill Princeton University
...
\years{2001 SDRC}Special Seminar, Schlumberger-Doll Research Center\hfill Ridgefield, CT\\
...
\noindent
\years{2017}Speaker, NSF ExCAPE PI Meeting \hfill Philadelphia, PA\\
\years{2017}``Community-building for data-intensive computer \& computing science\\ education infrastructure research'' (SPLICE) \hfill Pittsburgh, PA\\

\subsection*{Independent research organizations}
\noindent
\years{2017}Y Conf hosted by Y Combinator Research \hfill San Francisco\\
\years{2016} Speaker, Tools for Thought, Recurse Center \hfill NYC\\
...
\section*{Publications in Human-Computer Interaction}

\subsection*{Journal articles}
\noindent
%\emph{Learning at scale}\\
\years{2015 TOCHI}OverCode: visualizing variation in student solutions to programming problems at scale\\\textbf{E Glassman}, J Scott, R Singh, P Guo, RC Miller\\ \emph{ACM Transactions on Computer-Human Interaction}, 22 (2)\\
...
\years{2017 L@S}Writing Reusable Code Feedback at Scale with Mixed-Initiative Program Synthesis\\A Head, \textbf{E Glassman}, G Soares, R Suzuki, L Figueredo, L D'Antoni and B Hartmann\\  ACM Learning at Scale\\
\emph{13\% acceptance rate}\\\\
\years{2017 VL/HCC}TraceDiff: Debugging Unexpected Code Behavior Using Trace Divergences\\ R Suzuki, G Soares, A Head, \textbf{E Glassman}, R Reis, M Mongiovi, L D'Antoni, and B Hartmann\\ IEEE Symposium on Visual Languages and Human-Centric Computing\\
\emph{29\% acceptance rate}\\\\
\years{2016 CSCW}Learnersourcing Personalized Hints\\ \textbf{E Glassman}, A Lin, CJ Cai, RC Miller\\ ACM Computer-Supported Cooperative Work and Social Computing\\
\emph{25\% acceptance rate}\\\\
\years{2016 ASIST}DocMatrix: Self-Teaching from Multiple Sources\\ \textbf{E Glassman}, DM Russell\\ ASIS\&T Annual Meeting\\
\emph{40\% acceptance rate}\\\\
\years{2015 UIST}Foobaz: Variable Name Feedback for Student Code at Scale\\\textbf{E Glassman}, L Fischer, J Scott, RC Miller\\ ACM Symposium on User Interface Software \& Technology\\
\emph{23.6\% acceptance rate}\\\\
%\newpage
\years{2015 CHI}Mudslide: A Spatially Anchored Census of Student Confusion for Online Lecture Videos\\ \textbf{E Glassman}, J Kim, A Monroy-Hernández, MR Morris\\  \emph{ACM Conference on Human Factors in Computing Systems}\\ 
\emph{23\% acceptance rate}\\
\textbf{Best of CHI Honorable Mention}\\\\
\years{2015 CHI}RIMES: Embedding Interactive Multimedia Exercises in Lecture Videos\\ J Kim, \textbf{EL Glassman}, A Monroy-Hernández, MR Morris\\  ACM Conference on Human Factors in Computing Systems\\
\emph{23\% acceptance rate}\\\\
\years{2013 ICER}Toward Facilitating Assistance to Students Attempting Engineering Design Problems\\\textbf{E Glassman}, N Gulley, RC Miller\\  ACM International Computing Education Research\\
...
\years{2015 MIT}iBCM: Interactive Bayesian Case Model Empowering Humans via Intuitive Interaction\\B Kim, \textbf{E Glassman}, B Johnson, J Shah\\  MIT CSAIL TR-2015-010

\subsection*{Book Chapters}
\noindent
%\emph{Learning at scale}\\
\years{2016 US Army}Making Static Lessons Adaptive through Crowdsourcing \& Machine Learning\\ JJ Williams, J Kim, \textbf{E Glassman}, A Rafferty, W Lasecki\\  Volume 4 of Design Recommendations for Intelligent Tutoring Systems\\US Army Research Laboratory
...
\noindent
\years{2017 CHI}Exploring the Design Space of Automatically Synthesized Hints for Introductory Programming Assignments\\R Suzuki, G Soares, {\bf E Glassman}, A Head, L D'Antoni, and B Hartmann \\[.1cm] %ACM CHI Conference on Human Factors in Computing Systems\\
\years{2017 L@S} Teamscope: Scalable Team Evaluation via Automated Metric Mining for Communication, Organization, Execution, and Evolution\\ A Ju, {\bf E Glassman}, A Fox\\[.1cm] %ACM Learning at Scale Conference\\
\years{2016 ICML}Learning Latent Student Design Decisions in Python Programming Classes\\{\bf E Glassman} \\Workshop on Machine Learning for Digital Education and Assessment Systems\\[.1cm]
%International Conference on Machine Learning\\
\years{2016 MSR}Learning Latent Student Design Decisions in Massive Python Programming Classes \\{\bf E Glassman} \\New England Machine Learning Day\\[.1cm]
\years{2016 CSCW}Leveraging Learners for Teaching Programming and Hardware Design at Scale\\{\bf E Glassman}, R Miller \\[.1cm]%ACM Computer-Supported Cooperative Work and Social Computing\\
\years{2016 CSCW}Scaling Up Qualitative Data Analysis With Interfaces Powered by Interpretable Machine Learning \\{\bf E Glassman}, B Kim, J Shah\\Human Centered Data Science Workshop\\[.1cm]%ACM Symposium on User Interface Software \& Technology\\ 
...
%\newpage
\years{2015 L$@$S}Learner-Sourcing in an Engineering Class at Scale\\{\bf E Glassman}, C Terman, R Miller\\[.1cm] %ACM Learning at Scale Conference\\
\years{2014 UIST}Interacting with Massive Numbers of Student Solutions\\{\bf E Glassman}\\[.1cm] %ACM Symposium on User Interface Software \& Technology\\
\years{2014 L$@$S}Feature Engineering for Clustering Student Solutions\\{\bf E Glassman}, R Singh, R Miller%\\ACM Learning at Scale Conference\\
...
\years{2012 ICRA}Region of attraction estimation for a perching aircraft: A Lyapunov method exploiting barrier certificates \\\textbf{E Glassman}, A Desbiens, M Tobenkin, M Cutkosky, and R Tedrake\\IEEE International Conference on Robotics and Automation\\
\emph{40\% acceptance rate}\\\\
\years{2010 ICRA}A quadratic regulator-based heuristic for rapidly exploring state space\\\textbf{E Glassman} and R Tedrake\\ IEEE International Conference on Robotics and Automation\\[.2cm]
\emph{Posters}\\
\years{2009 NIPS}{\bf E Glassman}\\Women in Machine Learning Workshop\\
Neural Information Processing Systems\\[.2cm]
\emph{Theses}\\
\years{2010 MIT}A quadratic regulator-based heuristic for rapidly exploring state space\\\textbf{E Glassman} \\MIT EECS M.Eng. Thesis\\
...
\emph{Conference publications}\\
\years{2006 EMBS}Reducing the number of channels for an ambulatory patient-specific EEG-based epileptic seizure detector by applying recursive feature elimination\\\textbf{E Glassman}, J Guttag \\IEEE Engineering in Medicine and Biology Society
...
\years{2016-17}Andrew Head, EECS Ph.D. student \hfill UC Berkeley\\
...
\years{2015}Aaron Lin, EECS undergraduate \hfill MIT
%{\it Supervised r}\\
