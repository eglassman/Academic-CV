...
\noindent
%\emph{Learning at scale}\\
\years{2017 CHI}\emph{In submission, details available upon request}\\
Project name: Visualizing code examples at scale\\\\
\years{2017 CHI}\emph{In submission, details available upon request}\\
Project name: Mixed-initiative code example extraction\\\\
