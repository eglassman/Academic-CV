...
\emph{Funded by} NSF Expeditions in Computer Augmented Program Engineering\\ and the Berkeley Institute of Data Science Postdoctoral Fellowship\\[0.05cm]
\emph{Supervised by} Bj{\"o}rn Hartmann, Associate Professor of EECS\\[0.1cm]
\years{2012-2016}Graduate student \hfill User Interface Design Group, EECS Department, CSAIL, MIT\\[0.05cm]
\emph{PhD Thesis} ``Clustering and Visualizing Solution Variation in Massive Programming Classes''\\[0.05cm]
\emph{Advised by} Robert Miller, Distinguished Professor of CS\\[0.1cm]
\years{2008-2011}Graduate student\hfill Robot Locomotion Group, EECS Department, CSAIL, MIT\\[0.05cm]
\emph{M.Eng. Thesis} ``A quadratic regulator-based heuristic for rapidly exploring state space''\\[0.05cm]
\emph{Advised by} Russ Tedrake, Professor of EECS\\[0.1cm]
...
\subsection*{Chairs and Organizing Committees}
\noindent
...
\years{2017, 2019}ACM UIST Session chair, ``Code/Education Session'' and ``Software and Hardware Development''\\
...
\noindent
\years{2017}NSF ExCAPE PI Meeting\\
\years{2018}Dan Schwartz and Carl Wieman's joint lab seminar, Stanford Graduate School of Education \hfill Stanford, CA\\
...
\subsection*{DARPA}
\noindent
\years{2017}Diverse Ways of Inferring Missions \hfill Washington, D.C.\\
...
\noindent
\years{2017,2019}Approaches and Applications of Inductive Programming \hfill Wadern, Germany
