...
{\large Assistant Professor of Computer Science [2019-present]\\ 
Harvard John A. Paulson School Of Engineering And Applied Sciences\\
[0.1cm]
Stanley A. Marks \& William H. Marks Professor at the Radcliffe Institute for Advanced Study [2018-2022] }\\[0.4cm]
%Harvard University\\
...
\textit{Lab} \href{http://glassmanlab.seas.harvard.edu/}{glassmanlab.seas.harvard.edu} (recently renamed \textit{The Variation Lab})
%\vspace{-5mm}
%\hrule
...
\years{2003-2004}Volunteer research assistant \hfill EEG Lab, Pyschology Dept, Princeton University
...
\noindent
Top-tier ACM conferences in human-computer interaction, e.g., CHI, CSCW, \& UIST, are highly selective venues for archival papers only, comparable to many IEEE journals in their selectivity, visibility, and impact.\\
...
The last author is the primary sponsor and supervisor.\\ %, and project advisor.
\emph{* indicates equal contribution.}\\
\emph{$\dagger$ indicates a PhD advisee or pre-doctoral research assistant.}\\
...
\emph{** indicates a PhD student for which I served as a doctoral thesis committee member.}
...
\subsubsection*{2024 ACM Conference on Human Factors in Computing Systems \textbf{(CHI)}}
Flagship HCI conference\\
26.4\% acceptance rate for main paper track (Full Paper)\\
33.9\% acceptance rate for Late Breaking Work (LBW)\\
All main track camera ready papers have been submitted.\\[0.2cm]
\years{\textbf{[CN]}} Z Gu$\dagger$, I Arawjo$\mathsection$, K Li$\|$, JK Kummerfeld$\dagger\dagger$, \textbf{EL Glassman}\\ \textit{An AI-Resilient Text Rendering Technique for Reading and Skimming Documents}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
%(Camera Ready Submitted, awaiting final confirmation of acceptance)\\
[0.2cm]
\years{\textbf{[CN]}} KI Gero$\mathsection$, C Swoopes$\dagger$, Z Gu$\dagger$, JK Kummerfeld$\dagger\dagger$, \textbf{EL Glassman}\\ \textit{Supporting Sensemaking of Large Language Model Outputs at Scale}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]}} P Vaithilingam$\dagger$, \textbf{EL Glassman}, JP Inala, C Wang\\ \textit{DynaVis: Dynamically Synthesized UI Widgets for Visualization Editing}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]}} I Arawjo$\mathsection$, C Swoopes$\dagger$, P Vaithilingam$\dagger$, M Wattenberg, \textbf{EL Glassman}\\ \href{https://arxiv.org/abs/2309.09128}{ChainForge: A Visual Toolkit for Prompt Engineering and LLM Hypothesis Testing}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]} LBW}Z Gu$\dagger$, O Raymond, N Al Madi, \textbf{EL Glassman}\\
\textit{Why Do Skimmers Perform Better with Grammar-Preserving Text Saliency Modulation (GP-TSM)? Evidence from an Eye Tracking Study}
%Late Breaking Work
%[0.3cm]

\subsubsection*{2023 ACM Conference on Human Factors in Computing Systems \textbf{(CHI)}}
Similar acceptance rates to 2024 conference above.\\[0.2cm]
\years{\textbf{[CN]}}SA Gebreegziabher, Z Zhang, X Tang, Y Meng, \textbf{EL Glassman}, TJ Li\\ \href{http://glassmanlab.seas.harvard.edu/papers/patat_CHI23.pdf}{PaTAT: Human-AI Collaborative Qualitative Coding with Explainable Interactive Rule Synthesis}\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]} LBW}H Heuer$\dagger\dagger$, \textbf{EL Glassman}\\
...
\subsubsection*{2023 ACM Transactions on Computer-Human Interaction \textbf{(TOCHI)}}
This is a highly respected journal in my field. Accepted papers are guaranteed a presentation at the authors' pick of several top-tier ACM HCI conferences.\\

\years{\textbf{[JN]}}N Singh*$\|$, G Bernal*$\|$, D Savchenko*$\|$, \textbf{EL Glassman}\\
\href{http://glassmanlab.seas.harvard.edu/papers/elephant_tochi2022.pdf}{Where to Hide a Stolen Elephant: Leaps in Creative Writing with Multimodal Machine Intelligence}\\[0.2cm]
%\emph{ACM Transactions on Computer-Human Interaction}
\years{\textbf{[JN]}}H Heuer$\dagger\dagger$, \textbf{EL Glassman}\\
\href{https://dl.acm.org/doi/pdf/10.1145/3635147}{Reliability Criteria for News Websites}
%\emph{ACM Transactions on Computer-Human Interaction}\\


\subsubsection*{2023 Other Peer-Reviewed Conference Papers}
Acceptance rates at these conferences are typically between 30-40\%.\\

\years{\textbf{[CN]}\\ICSE-SEIP}P Vaithilingam$\dagger$, \textbf{EL Glassman}, P Groenwegen, S Gulwani, AZ Henley, R Malpani, D Pugh, A Radhakrishna, G Soares, J Wang, A Yim\\ \href{https://austinhenley.com/pubs/Vaithilingam2023ICSE_IntelliCode.pdf}{Towards More Effective AI-Assisted Programming: A Systematic Design Exploration to Improve Visual Studio Intelli-Code’s User Experience}\\
\emph{IEEE/ACM International Conference on Software Engineering: Software Engineering in Practice}\\[0.2cm]
\years{\textbf{[CN]}\\MuC}H Heuer$\dagger\dagger$, \textbf{EL Glassman}\\
\href{https://dl.acm.org/doi/abs/10.1145/3603555.3603569}{Accessible Text Tools for People with Cognitive Impairments and Non-Native Readers: Challenges and Opportunities}\\
\emph{Mensch und Computer}



\subsubsection*{2022 ACM User Interface Software \& Technology \textbf{(UIST)}}
Typically between 20-25\% acceptance rate.\\
\years{\textbf{[CN]}}L Yan$\dagger$, M Kim$\ddagger\ddagger$, B Hartmann$\ddagger\ddagger$, T Zhang$\mathsection$, \textbf{EL Glassman}\\ \href{http://glassmanlab.seas.harvard.edu/papers/paralib_uist22.pdf}{Concept-Annotated Examples for Library Comparison}\\
\emph{ACM Symposium on User Interface Software \& Technology}

\subsubsection*{2022 ACM/IEEE International Conference on Human-Robot Interaction \textbf{(HRI)}}
Typically between 20-25\% acceptance rate.\\
\years{\textbf{[CN]}}S Booth**, S Sharma$\|$, S Chung, J Shah, \textbf{EL Glassman}\\
...
\subsubsection*{2022 ACM Conference on Human Factors in Computing Systems \textbf{(CHI)}}
Similar acceptance rates to 2024 conference above.\\[0.2cm]
\years{\textbf{[CN]}}H Heuer$\dagger\dagger$, \textbf{EL Glassman}\\
...
%\emph{ACM Conference on Human Factors in Computing Systems}%\\
%Typically 23-25\% acceptance rate\\[0.2cm]
\years{\textbf{[CN]} LBW}P Vaithilingam$\dagger$, T Zhang$\mathsection$, \textbf{EL Glassman}\\
\href{https://tianyi-zhang.github.io/files/chi2022-lbw-copilot.pdf}{Expectation vs. Experience: Evaluating the Usability of Code Generation Tools Powered by Large Language Models}\\
%\emph{Extended Abstracts of the 2022 CHI Conference on Human Factors in Computing Systems}\\[0.2cm]
\years{2022 ICWSM}Z Epstein*$\|$, N Foppiani*$\|$, S Hilgard*$\|$, S Sharma*$\|$, \textbf{EL Glassman}, D Rand\\
...
\subsubsection*{2021}
\years{2021 UIST}J Hu**, P Vaithilingam$\dagger$, S Chong, M Seltzer, \textbf{EL Glassman}\\
...
\years{2021 CACM}S Chasins, \textbf{EL Glassman}, J Sunshine\\
\href{http://glassmanlab.seas.harvard.edu/papers/PLandHCI_betterTogether.pdf}{PL and HCI: Better Together}\\
\emph{Communications of the ACM} Vol. 64, Issue 8\\[0.2cm]
\years{2021 CHI}\hl{\textbf{Best of CHI Honorable Mention (top 5\%)}} A Ross, N Chen, E Zhao Hang, \textbf{EL Glassman}, F Doshi-Velez\\
\href{http://glassmanlab.seas.harvard.edu/papers/evalGenModels_chi2021.pdf}{Evaluating the Interpretability of Generative Models by Interactive Reconstruction}\\
\emph{ACM Conference on Human Factors in Computing Systems}\\
23-25\% acceptance rate\\[0.2cm]
\years{2021 CHI} T Zhang$\mathsection$, Z Chen, Y Zhu, P Vaithilingam$\dagger$, X Wang, \textbf{EL Glassman}\\
\href{http://glassmanlab.seas.harvard.edu/papers/ips_chi2021.pdf}{Interpretable Program Synthesis}\\
\emph{ACM Conference on Human Factors in Computing Systems}\\
23-25\% acceptance rate\\[0.2cm]
\years{2021 CHI}\hl{\textbf{Best of CHI Honorable Mention (top 5\%)}} L Yan$\dagger$, \textbf{EL Glassman}, T Zhang$\mathsection$\\
\href{http://glassmanlab.seas.harvard.edu/papers/examplenet_chi2021.pdf}{Visualizing Examples of Deep Neural Networks at Scale}\\
\emph{ACM Conference on Human Factors in Computing Systems}\\
23-25\% acceptance rate

\subsubsection*{2020}
\years{2020 FSE}C Barnaby, K Sen, T Zhang$\mathsection$, \textbf{EL Glassman}, and S Chandra\\
...
\years{2020 UIST} T Zhang$\mathsection$, L Lowmanstone$\ddagger$, X Wang, \textbf{EL Glassman}\\
...
\years{2020 CHI}T Zhang$\mathsection$, B Hartmann$\ddagger\ddagger$, M Kim$\ddagger\ddagger$, \textbf{EL Glassman}\\
...
\years{2023 arXiv}\textbf{EL Glassman}\\\href{https://arxiv.org/pdf/2309.02257.pdf}{Designing Interfaces for Human-Computer Communication: An On-Going Collection of Considerations}\\[.2cm]
\years{2023 arXiv}Y Pu, S Vaduguru, P Vaithilingam$\dagger$, \textbf{EL Glassman}, D Fried\\\href{https://arxiv.org/pdf/2309.03225}{Amortizing Pragmatic Program Synthesis with Rankings}\\[.2cm]
\years{2023 arXiv}P Vaithilingam$\dagger$, Y Pu, \textbf{EL Glassman}\\\href{https://arxiv.org/pdf/2308.06656}{The Usability of Pragmatic Communication in Regular Expression Synthesis}\\[.2cm]
\years{2023 arXiv}A Cai$\|$, C Ardayfio, AP Nguyen, T Lin, \textbf{EL Glassman}\\\href{https://arxiv.org/abs/2311.11238}{AtomXR: Streamlined XR Prototyping with Natural Language and Immersive Physical Interaction}\\[.2cm]
\years{2023 arXiv}J Zhou, \textbf{EL Glassman}, DS Weld\\\href{https://arxiv.org/pdf/2303.06264}{An Interactive UI to Support Sensemaking over Collections of Parallel Texts}\\[.2cm]
\years{2022 arXiv}S Ali$\|$, S Upadhyay$\|$, G Hiranandani, \textbf{EL Glassman}, O Koyejo\\\href{https://arxiv.org/pdf/2212.03495}{Metric Elicitation; Moving from Theory to Practice}\\[.2cm]
\years{2015 CSAIL}B Kim, \textbf{EL Glassman}, B Johnson, J Shah\\
...
\years{2022}KI Gero, JK Kummerfeld, \textbf{EL Glassman}\\
\textit{Sensemaking Interfaces for Human Evaluation of Language Model Outputs}\\[0.2cm]
\years{2022 ACL}N Singh*, G Bernal*, D Savchenko*, \textbf{EL Glassman}\\
...
\emph{Workshop on Intelligent and Interactive Writing Assistants (In2Writing 2022) @ ACL}\\[0.2cm]
...
\years{2021 VAHC}T Zhang, TH McCoy Jr., RH Perlis, F Doshi-Velez, \textbf{EL Glassman}\\
...
\years{2021 MiC}S Bridgers, \textbf{EL Glassman}, L Schulz, T Ullman\\
...
\emph{(MiC) Workshop @ NeurIPS}\\[0.2cm]
...
\years{2021-25}Co-PI, HCC: Medium: Improving Human-AI Collaboration on Decision-Making Tasks\\
...
\years{2021-23}Co-PI, Collaborative Research: Loopholes as a window into the learning of meaning\\
...
\subsection*{Industry}
\noindent
\years{2023-24}Amazon Research Award\\
\years{2019-present}Facebook/Meta\\
\subsection*{Harvard}
\noindent
...
\noindent
\years{2023}Sloan Foundation Fellowship
...
\years{2023,24}Onward! Essays at the ACM SIGPLAN SPLASH conference\\
...
\years{2019}ACM UIST Doctoral Consortium Co-Chair\\
...
\subsection*{Institute, School and University committees}
...
\years{2022,23}Communications of the ACM (CACM)\hfill ACM\\
...
\years{2017, '21, '23, '24}Transactions on Computer-Human Interaction (TOCHI)\hfill ACM\\[0.2cm]
\textit{Conferences}\\
...
%\years{2022-present}Sonia Murphy\hfill Harvard CS\\
...
\years{2021-present}Edwin Chng\hfill Harvard HGSE\\
\years{2023-present}Hussein Mozannar\hfill MIT EECS\\
...
\textit{Additional Post-Undergrad Student Research Mentees}\\
\years{2021-2022}Sharon Tai\hfill Harvard Extension\\
\years{2021-2022}Daria Savchenko\hfill Harvard Anthropology\\
\years{2021-2022}Guillermo Bernal\hfill MIT Media Lab\\
\years{2021-2022}Nikhil Singh\hfill MIT Media Lab\\
...
%\years{2023}Janna Withrow\hfill Harvard CS \& Math\\
\years{2023-24}Tara Nadella\hfill Harvard CS\\
\years{2023}Leah Teichholtz\hfill Harvard CS\\
\years{2023}Karina Halevy\hfill Harvard CS \& History\\
...
\years{2021}Wassim Marrakchi\hfill Harvard CS\\[0.2cm]
...
\years{2019-22}Concentration advisor to $\approx$15 CS students, annually\hfill Harvard CS \\
\years{2019-2022}First year advisor to 3 to 4 freshman women with interest in CS\hfill Harvard FAS \\[0.2cm]
...
\years{2023}Course Head, CS178 Engineering Usable Interactive Systems (33 students)\hfill{Harvard CS}\\
\years{2020,22,23}Course Head, CS279R Research Topics in HCI ($\approx$35-45 students) \hfill Harvard CS\\
...
\years{2020, 21}Course Head, CS179 Design of Useful \& Usable Interactive Systems ($\approx$75, then $\approx$115 students) \hfill Harvard CS\\
...
\noindent
\years{2024}CHI workshop on LLMs as Research Tools\\
\years{2023}Generative AI for Education (GAIED) Workshop (NeurIPS)\\
\years{2023}IEEE Symposium on Visual Languages and Human-Centric Computing (VL/HCC)\\
\years{2022}Workshop on User-Centered Artificial Intelligence (UCAI)\\
...
\noindent
\years{2024}ETH CS Distinguished Lecture \hfill ETH
...
\years{2022, '23}Executive education course “Leadership in AI” \hfill Harvard SEAS/HKS\\
\years{2022}PROSE Group Meeting\hfill MSR Redmond\\
\years{2022}PAIR (People + AI Research) Talks\hfill Google\\
\years{2022}``Advancing Human-AI Communication and Interaction'' Symposium\hfill APS Annual Convention\\
\years{2022}``Misunderstanding and misalignment in children and machines'' Symposium\hfill CDS\\
...
\years{2023}Invited Speaker, Saturday of Symposia, Harvard Alumni Association\\
\years{2022}Panelist, IEEE STEM Summit, Presidents' Scholarship session\\
\years{2022}Panelist, MIT Horizon event, ``How Humans Can Understand Robot Behaviors''\\
