...
\years{2020 FSE} Celeste Barnaby, Koushik Sen, Tianyi Zhang, \textbf{EL Glassman}, and Satish Chandra\\
Exempla Gratis (E.G.): Code Examples for Free\\
Industry Track\\
\emph{ACM Joint European Software Engineering Conference \& Symposium on the Foundations of Software Engineering}\\[0.2cm]
\years{2020 UIST} Tianyi Zhang, London Lowmanstone, Xinyu Wang, \textbf{EL Glassman}\\
...
\years{2020 CHI}Tianyi Zhang, Björn Hartmann, Miryung Kim, \textbf{EL Glassman}\\
...
Zana Bucinca*, Phoebe Lin*, Krzysztof Gajos, \textbf{EL Glassman}\\
...
\subsection*{NSF}
\noindent
\years{2020}Lead PI, \emph{Collaborative Research: CHS: Medium: Code demography: Addressing information needs at scale for programming interface users and designers}
\subsection*{Industry}
\noindent
\years{2019}Facebook
...
\years{2019, 2020}Workshop on Intelligent Textbooks\hfill AIED \\
...
\noindent
\years{2020-2021}ACM UIST Publicity Co-Chair\\
...
\years{2019-present}Tianyi Zhang\hfill Harvard CS\\
\years{2019-present}Berk Ustun\hfill Harvard CRCS\\[0.2cm]
...
\years{2020}Litao Yan\hfill Computational Science \& Engineering\\
...
\years{2019,2020}Cole Bateman, Undergraduate\hfill Harvard CS\\
\years{2019}Phoebe Lin, Masters student\hfill Harvard Graduate School of Design\\
...
\years{2021}Lecturer, CS179 Design of Useful \& Usable Interactive Systems ($\approx$ 75 students) \hfill Harvard CS\\
...
\years{2018}Rising Stars workshop for aspiring female EECS professors\hfill MIT EECS\\
...
\noindent
\years{2020}Workshop on Computer Assisted Programming \textit{TBD} \hfill NeurIPS\\
\years{2020}PurPL Seminar Series, \textit{to be scheduled}\hfill Purdue\\
\years{2020}CS Department Seminar, \textit{to be rescheduled}\hfill Wesleyan\\
\years{2020}BostonCHI, \textit{to be rescheduled} \hfill Cambridge, MA\\
...
\years{2018}Dan Schwartz and Carl Wieman's lab @ Stanford Graduate School of Education \hfill Stanford\\
...
\noindent
\years{2020-present}Faculty sponsor of the provisional Harvard Women's Wrestling Club \hfill Harvard\\
...
\href{http://glassmanlab.seas.harvard.edu/Academic_CV.pdf}{http://glassmanlab.seas.harvard.edu/Academic_CV.pdf}}
\end{center}
