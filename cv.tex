...
\emph{$\dagger$ indicates my PhD advisee or pre-doctoral research assistant.}\\
\emph{$\ddagger$ indicates a Harvard undergraduate student I am supervising.}\\
\emph{$\|$ indicates a student who took my graduate research seminar, CS279R.}\\
...
\subsubsection*{2024 ACM Conference on Human Factors in Computing Systems}
Flagship HCI conference\\
26.4\% acceptance rate for main paper track (paper)\\
33.9\% acceptance rate for Late Breaking Work (LBW)\\
All main track camera ready papers have been submitted.\\[0.2cm]
\years{CHI paper} Z Gu$\dagger$, I Arawjo$\mathsection$, K Li, JK Kummerfeld, \textbf{EL Glassman}\\ \textit{An AI-Resilient Text Rendering Technique for Reading and Skimming Documents}\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
%(Camera Ready Submitted, awaiting final confirmation of acceptance)\\
[0.2cm]
\years{CHI paper} KI Gero$\mathsection$, C Swoopes$\dagger$, Z Gu$\dagger$, JK Kummerfeld, \textbf{EL Glassman}\\ \textit{Supporting Sensemaking of Large Language Model Outputs at Scale}\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{CHI paper} P Vaithilingam$\dagger$, \textbf{EL Glassman}, JP Inala, C Wang\\ \textit{DynaVis: Dynamically Synthesized UI Widgets for Visualization Editing}\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{CHI paper} I Arawjo$\mathsection$, C Swoopes$\dagger$, P Vaithilingam$\dagger$, M Wattenberg, \textbf{EL Glassman}\\ \href{https://arxiv.org/abs/2309.09128}{ChainForge: A Visual Toolkit for Prompt Engineering and LLM Hypothesis Testing}\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{CHI LBW}Z Gu$\dagger$, O Raymond, N Al Madi, \textbf{EL Glassman}\\
...
\emph{Mensch und Computer}\\[0.2cm]
\years{2023 CHI EA}H Heuer, \textbf{EL Glassman}\\
...
\emph{Extended Abstracts of the 2023 CHI Conference on Human Factors in Computing Systems}\\[0.2cm]
\years{2023 TOCHI}N Singh*, G Bernal*, D Savchenko*, \textbf{EL Glassman}\\
...
\emph{ACM Transactions on Computer-Human Interaction}\\[0.2cm]
\years{2022 UIST}L Yan, M Kim, B Hartmann, T Zhang, \textbf{EL Glassman}\\ \href{http://glassmanlab.seas.harvard.edu/papers/paralib_uist22.pdf}{Concept-Annotated Examples for Library Comparison}\\
\emph{ACM Symposium on User Interface Software \& Technology}\\[0.2cm]
\years{2022 HRI}S Booth, S Sharma, S Chung, J Shah, \textbf{EL Glassman}\\
...
\years{2022 CHI EA}P Vaithilingam$\dagger$, T Zhang, \textbf{EL Glassman}\\
...
\years{2022 CHI}H Heuer, \textbf{EL Glassman}\\
...
\emph{International AAAI Conference on Web and Social Media}\\[0.2cm]
...
\years{2021 CHI} T Zhang, Z Chen, Y Zhu, P Vaithilingam$\dagger$, X Wang, \textbf{EL Glassman}\\
