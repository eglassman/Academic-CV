...
\years{\textbf{[CN]}} Z Gu$\dagger$, I Arawjo$\mathsection$, K Li$\|$, JK Kummerfeld$\dagger\dagger$, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/gptsm.pdf}{An AI-Resilient Text Rendering Technique for Reading and Skimming Documents}\\
\textit{Provisional patent filed}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
%(Camera Ready Submitted, awaiting final confirmation of acceptance)\\
[0.2cm]
\years{\textbf{[CN]}} KI Gero$\mathsection$, C Swoopes$\dagger$, Z Gu$\dagger$, JK Kummerfeld$\dagger\dagger$, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/mesotext.pdf}{Supporting Sensemaking of Large Language Model Outputs at Scale}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]}} P Vaithilingam$\dagger$, \textbf{EL Glassman}, JP Inala, C Wang\\ \href{https://glassmanlab.seas.harvard.edu/papers/dynavis.pdf}{DynaVis: Dynamically Synthesized UI Widgets for Visualization Editing}\\
\textit{(Microsoft Internship Project)}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]}} I Arawjo$\mathsection$, C Swoopes$\dagger$, P Vaithilingam$\dagger$, M Wattenberg, \textbf{EL Glassman}\\ \href{https://glassmanlab.seas.harvard.edu/papers/chainforge.pdf}{ChainForge: A Visual Toolkit for Prompt Engineering and LLM Hypothesis Testing}\\
%Full CHI Paper\\
%\emph{ACM Conference on Human Factors in Computing Systems}\\
[0.2cm]
\years{\textbf{[CN]} LBW}Z Gu$\dagger$, O Raymond, N Al Madi$\dagger\dagger$, \textbf{EL Glassman}\\
...
\years{\textbf{[CN]}}Z Epstein*$\|$, N Foppiani*$\|$, S Hilgard*$\|$, S Sharma*$\|$, \textbf{EL Glassman}, D Rand\\
...
\years{\textbf{[CN]}}J Hu**, P Vaithilingam$\dagger$, S Chong, M Seltzer, \textbf{EL Glassman}\\
...
\years{\textbf{[MN]}}S Chasins, \textbf{EL Glassman}, J Sunshine\\
...
\years{\textbf{[CN]}}\hl{\textbf{Best of CHI Honorable Mention (top 5\%)}}\\
...
\href{http://glassmanlab.seas.harvard.edu/papers/examplenet_chi2021.pdf}{Visualizing Examples of Deep Neural Networks at Scale}\\
[0.2cm]
\years{\textbf{[CN]}} T Zhang$\mathsection$, Z Chen, Y Zhu, P Vaithilingam$\dagger$, X Wang, \textbf{EL Glassman}\\
...
\years{\textbf{[CN]}}T Zhang$\mathsection$, L Lowmanstone$\ddagger$, X Wang, \textbf{EL Glassman}\\
...
\years{\textbf{[CN]}}T Zhang$\mathsection$, B Hartmann$\ddagger\ddagger$, M Kim$\ddagger\ddagger$, \textbf{EL Glassman}\\
...
\years{\textbf{[CN]}}\hl{\textbf{Best Paper Award}}\\
Z Bucinca*, P Lin*$\|$, K Gajos, \textbf{EL Glassman}\\
\href{http://glassmanlab.seas.harvard.edu/papers/bucinca_iui20_proxy.pdf}{Proxy Tasks and Subjective Measures Can Be Misleading in Evaluating XAI Systems}\\
\emph{ACM Intelligent User Interfaces}\\
...
\years{2023 arXiv}A Cai$\|$, C Ardayfio$\ddagger$, AP Nguyen$\ddagger$, T Lin**, \textbf{EL Glassman}\\\href{https://arxiv.org/abs/2311.11238}{AtomXR: Streamlined XR Prototyping with Natural Language and Immersive Physical Interaction}\\[.2cm]
\years{2023 arXiv}J Zhou, \textbf{EL Glassman}, DS Weld\\\href{https://arxiv.org/pdf/2303.06264}{An Interactive UI to Support Sensemaking over Collections of Parallel Texts}\\
\textit{Masters Thesis at University of Washington CS that I unofficial co-advised}\\[.2cm]
\years{2022 arXiv}S Ali$\|$, S Upadhyay$\|$, G Hiranandani, \textbf{EL Glassman}, O Koyejo\\\href{https://arxiv.org/pdf/2212.03495}{Metric Elicitation; Moving from Theory to Practice}\\
...
\years{2022 NeurIPS}KI Gero$\mathsection$, JK Kummerfeld$\dagger\dagger$, \textbf{EL Glassman}\\
...
\years{2021 VIS}\hl{\textbf{Honorable Mention Award}}\\T Zhang$\mathsection$, TH McCoy Jr., RH Perlis, F Doshi-Velez, \textbf{EL Glassman}\\
...
\years{2021 NeurIPS}S Bridgers, \textbf{EL Glassman}, L Schulz, T Ullman\\
...
\years{2020 C+J}\textbf{EL Glassman}, Janet Sung$\dagger$, Katherine Qian$\ddagger$, Yuri Vishnevsky, Amy Zhang\\
...
\years{2019 PLATEAU}Rebecca Hao$\ddagger$ and {\bf EL Glassman}\\
...
\years{2023-24}Leah Teichholtz\hfill Harvard CS\\
\years{2022-23}Karina Halevy\hfill Harvard CS \& History\\
\years{2021}Wassim Marrakchi\hfill Harvard CS\\
\years{2020-21}Cole Bateman\hfill Harvard CS\\
\years{2020-21}Ahan Malhotra\hfill Harvard CS\\
\years{2020-21}George Moe\hfill Harvard CS\\
...
\years{2023, '24}``Human-Computer Interaction and AI: What practitioners need to know to design and build effective AI systems from a human perspective''\hfill CHI\\
